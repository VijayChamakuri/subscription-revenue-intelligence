...
4. The project-integrated calibrated logistic model reaches 0.996 ROC-AUC, 0.894 PR-AUC, and 0.004 Brier score. This unusually strong result reflects deliberately encoded simulation signals, not expected production performance.
...
3. **Retention triage:** Pilot review of the 70 account snapshots selected by the logistic model's cost-based threshold. Modeled economics assume a $35 contact cost, $900 retained margin if successful, and 18% success probability. Difficulty is medium. Monitor precision, incremental renewal through a controlled experiment, and calibration drift.
